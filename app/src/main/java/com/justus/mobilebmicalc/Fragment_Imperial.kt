 ...
 * Use the [fragment_Imperial.newInstance] factory method to
 * create an instance of this fragment.
 */
class fragment_Imperial : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment__imperial, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment fragment_Imperial.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            fragment_Imperial().apply {
        ...
        internal fun calculateBMI(height: Int, weight: Int): Float {
        ...
        private fun ResetEverything() {
            ...
            calculate_btn.visibility = VISIBLE
